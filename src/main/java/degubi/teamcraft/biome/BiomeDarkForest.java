...
public final class BiomeDarkForest extends Biome{
    ...
    public void decorate(World world, Random rand, BlockPos pos) {
        ...
        for(int x = 0; x < 30; x++){
            BlockPos pos1 = new BlockPos(pos.getX() + rand.nextInt(16) + 8, 30 + rand.nextInt(70), pos.getZ() + rand.nextInt(16) + 8);
    ...
    private static void addBushGens(World world, Random rand, int blockXPos, int blockZPos){
        for(int mul = 0; mul < 30; mul++){
             BlockPos pos = new BlockPos(blockXPos + rand.nextInt(16) + 8, 40 + rand.nextInt(80), blockZPos + rand.nextInt(16) + 8);
    ...
    private static void addCustomTree1(World world, Random rand, int blockXPos, int blockZPos){
        for(int mul = 0; mul < 15; mul++){
            BlockPos pos = new BlockPos(blockXPos + rand.nextInt(16) + 8, 40 + rand.nextInt(60), blockZPos + rand.nextInt(16) + 8);
